...
ChestX_path = os.path.expanduser("data/cdfsl/chest_xray/data2/images")


class ChestX(Dataset):
    def __init__(self, data_root, mode='train', csv_path=ChestX_path+"/Data_Entry_2017_v2020.csv", \
        ...
        single_image_name = self.image_name[0]
    ...
    def __getitem__(self, index):
        ...
        # Open image
        img_as_img = Image.open(self.img_path + single_image_name).convert('RGB')
