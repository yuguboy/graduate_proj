...
class IDM(nn.Module):
    def __init__(self, channel=64):
        ...
        self.adaptiveFC3 = nn.Linear(int(channel/8), 2)
        self.adaptiveFC4 = nn.Linear(int(channel/2), int(channel/4))
        self.adaptiveFC5 = nn.Linear(int(channel/4), int(channel/8))
    ...
    def forward(self, x):
        ...
        x_embd = self.adaptiveFC4(x_embd)
        x_embd = self.adaptiveFC5(x_embd)
