...
class SimpleBlock(nn.Module):
    ...
    def __init__(self, indim, outdim, half_res, flatten=False):
        ...
        if self.flatten:
            ...
            self.parametrized_layers.append(avgpool)
            self.parametrized_layers.append(Flatten())
...
class ResNet(nn.Module):
    def __init__(self,
        ...
        self.basic_layers = nn.Sequential(*trunk)
        ...
        for i in range(4):
            ...
            for j in range(list_of_num_layers[i]):
                ...
                is_f = (i==3)and(self.flatten)
                print(is_f)
                B = block(indim, list_of_out_dims[i], half_res, is_f)
                trunk.append(B)
